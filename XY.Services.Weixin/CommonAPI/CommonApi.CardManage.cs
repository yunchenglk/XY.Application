...
namespace XY.Services.Weixin
{
    ...
    public partial class CommonApi
    {
        ...
        /// <returns></returns>
        public static CardDeleteResultJson Card_Delete(string accessToken, string cardId)
        {
        ...
        /// <returns></returns>
        public static CardGetResultJson Card_Get(string accessToken, string code, string cardId = null)
        {
        ...
        /// <returns></returns>
        public static CardBatchGetResultJson Card_BatchGet(string accessToken, int offset, int count)
        {
        ...
        /// <param name="cardId"></param>
        /// <returns></returns>
        public static CardDetailGetResultJson Card_GetDetail(string accessToken, string cardId)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_ChangeCode(string accessToken, string code, string cardId, string newCode)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_Unavailable(string accessToken, string code, string cardId = null)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_AuthoritySet(string accessToken, string[] openIds, string[] userNames)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_MemberActivate(string accessToken, string membershipNumber, string code, string cardId, int initBonus, int initBalance, string bonus = null, string balance = null)
        {
            var urlFormat = string.Format("https://api.weixin.qq.com/card/testwhitelist/set?access_token={0}", accessToken);
        ...
        /// <returns></returns>
        public static MemberCardDeal Card_MemberDeal(string accessToken, string code, string cardId, string recordBonus, decimal addBonus, decimal addBalance, string recordBalance)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_MovieUpdate(string accessToken, string code, string cardId, string ticketClass, string showTime, int duration, string screeningRoom, string[] seatNumbers)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_BoardingPassCheckIn(string accessToken, string code, string cardId, string passengerName, string classType, string seat, string etktBnr, string qrcodeData, bool isCancel = false)
        {
        ...
        /// <returns></returns>
        public static WxJsonResult Card_BoardingPassCheckIn(string accessToken, string code, string cardId, decimal balance)
        {
