...
namespace XY.Services.Weixin.MessageHandlers
{
    ...
    /// </summary>
    public abstract class MessageHandler_<TC, TRequest, TResponse> : IMessageHandler_<TRequest, TResponse>
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        public MessageHandler_(Stream inputStream, int maxRecordCount = 0, object postData = null)
        {
        ...
        /// <param name="maxRecordCount"></param>
        /// <param name="postData">需要传入到Init的参数</param>
        public MessageHandler_(XDocument postDataDocument, int maxRecordCount = 0, object postData = null)
        {
            CommonInitialize(postDataDocument, maxRecordCount, postData);
        }
        ...
        /// <param name="maxRecordCount"></param>
        /// <param name="postData">需要传入到Init的参数</param>
        public MessageHandler_(RequestMessageBase requestMessageBase, int maxRecordCount = 0, object postData = null)
        {
