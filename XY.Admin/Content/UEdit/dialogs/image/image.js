...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if (list) {
                if ($.isFunction(parent.Uedit_imgAfter) ? parent.Uedit_imgAfter() : Uedit_imgAfter()) {
                    editor.execCommand('insertimage', list);
                    remote && editor.fireEvent("catchRemoteImage");
                } else {
                    parent.Uedit_imgAfter_Event(list);
                    remote && editor.fireEvent("catchRemoteImage");
                }
    ...
    OnlineImage.prototype = {
        ...
        getInsertList: function () {
            var list = [];
            align = getAlign();
            $("#imageList li").each(function (i, n) {
