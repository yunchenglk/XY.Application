...
!function ($) {
    ...
    $.fn.valid = function (object, options) {
        ...
        if (myoptions != null && validationError) {
            ...
            myobject.after('<span id="validerrmsg" class="help-inline" style="color: #FF0000; margin-left:5px;">' + myoptions + '</span>');
    ...
    $.fn.validation.defaults = {
        validRules: [
            ...
            { name: 'remote', validate: function (value) { return ($.trim(value) == ''); }, defaultMsg: '已经使用。' },
            //{ name: 'min', validate: function (value) { return ($.trim(value) == ''); }, defaultMsg: '请输入数字。' },
    ...
    var validateField = function (field, valid) {
        ...
        if (form) {
            ...
            if (fstyle == 0) {
                ...
                //el.find("input").after('<span class="help-block" id="valierr">' + errorMsg + '</span>');
            }
            else if (fstyle == 1) {
                ...
                controlGroup.find("#valierr").remove();
                //el.parent().find("input").after('<span class="help-block" id="valierr" style="color:#FF0000;display:inline-block;margin-left:3px">' + errorMsg + '</span>');
            }
        };//end !form
        return !error;
    };
                ...
                $(obj).find('input, textarea').each(function () {
                    ...
                    if (valid) {
                        if ($.inArray('required', valid) >= 0) {
                            // el.parent().find("input").after('<span class="help-block" id="valierr" style="color:#FF0000;display:inline-block;margin-left:3px">*</span>');
                        }
                    };
                });
            };
